...
/** Scheda Mercati — categorie, ricerca e lista completa. */
export default function MobileMarketsBrowse({
  type,
  symbol,
  catalog,
  catalogSummary,
  ...
  return (
    <div
      className={`mobile-markets${refreshingCatalog ? ' mobile-markets--refreshing' : ''}`}
    >
      <MobileCategoryBar
        type={type}
      ...
      <div className="mobile-explore__list-head">
        ...
        <button
          ...
          onClick={onRefresh}
          disabled={loadingMarket || loadingCatalog || refreshingCatalog}
