...
export const ETF_ASSETS = [
  ...
  { id: 'XLF', yahoo: 'XLF', name: 'Financial Select SPDR', hint: 'Settore finanziario USA', sector: 'Financial', pricingKind: 'perShare', unit: 'USD' },
  { id: 'XLV', yahoo: 'XLV', name: 'Health Care Select SPDR', hint: 'Sanità USA', sector: 'Health', pricingKind: 'perShare', unit: 'USD' },
  { id: 'XLI', yahoo: 'XLI', name: 'Industrial Select SPDR', hint: 'Industriale USA', sector: 'Industrial', pricingKind: 'perShare', unit: 'USD' },
  { id: 'XLP', yahoo: 'XLP', name: 'Consumer Staples SPDR', hint: 'Beni di prima necessità', sector: 'Staples', pricingKind: 'perShare', unit: 'USD' },
  { id: 'XLY', yahoo: 'XLY', name: 'Consumer Disc. SPDR', hint: 'Beni discrezionali', sector: 'Consumer', pricingKind: 'perShare', unit: 'USD' },
  { id: 'XLB', yahoo: 'XLB', name: 'Materials Select SPDR', hint: 'Materie prime USA', sector: 'Materials', pricingKind: 'perShare', unit: 'USD' },
  { id: 'XLU', yahoo: 'XLU', name: 'Utilities Select SPDR', hint: 'Utility USA', sector: 'Utilities', pricingKind: 'perShare', unit: 'USD' },
];
