 ...
 * Solo provider realmente applicabili (evita 404 Stooq / AV senza chiave).
 */
export const CATEGORY_SOURCES = {
  ...
  index: {
    ...
    providers: [{ id: 'yahoo-finance', label: 'Yahoo Finance', role: 'primary' }],
  },
  forex: {
    label: 'Forex',
    providers: [
  ...
  crypto: {
    ...
    providers: [
      ...
      { id: 'coingecko', label: 'CoinGecko', role: 'fallback' },
      { id: 'stooq', label: 'Stooq', role: 'fallback' },
      { id: 'alphavantage', label: 'Alpha Vantage', role: 'fallback' },
    ],
  },
