...
export const COMMODITY_REGISTRY = [
  ...
  },
  {
    ...
    name: 'Zucchero',
    family: 'agri',
    hint: 'ICE sugar #11 futures',
    pricingKind: 'perLb',
    unit: 'USD/libbra',
    yahooSpot: 'SB=F',
    futures: [
      { tenor: 'spot', label: 'Front month', yahoo: 'SB=F', months: 0 },
      { tenor: '3M', label: '3 mesi', yahoo: 'SB=F', months: 3 },
      { tenor: '6M', label: '6 mesi', yahoo: 'SB=F', months: 6 },
    ],
    macro: ['DXY', 'Brasile'],
    geo: ['Brasile', 'India'],
    climate: true,
    correlations: ['ZC=F', 'KC=F'],
  },
  {
    id: 'COFFEE',
    name: 'Caffè',
    family: 'agri',
    hint: 'Arabica coffee futures',
    pricingKind: 'perLb',
    unit: 'USD/libbra',
    yahooSpot: 'KC=F',
    futures: [
      { tenor: 'spot', label: 'Front month', yahoo: 'KC=F', months: 0 },
      { tenor: '3M', label: '3 mesi', yahoo: 'KC=F', months: 3 },
      { tenor: '6M', label: '6 mesi', yahoo: 'KC=F', months: 6 },
    ],
    macro: ['DXY'],
    geo: ['Brasile', 'Vietnam', 'Colombia'],
    climate: true,
    correlations: ['SB=F', 'ZC=F'],
  },
  {
    id: 'COTTON',
    name: 'Cotone',
    family: 'agri',
    hint: 'ICE cotton futures',
    pricingKind: 'perLb',
    unit: 'USD/libbra',
    yahooSpot: 'CT=F',
    futures: [
      { tenor: 'spot', label: 'Front month', yahoo: 'CT=F', months: 0 },
      { tenor: '3M', label: '3 mesi', yahoo: 'CT=F', months: 3 },
      { tenor: '6M', label: '6 mesi', yahoo: 'CT=F', months: 6 },
    ],
    macro: ['DXY', 'Cina textile'],
    geo: ['USA', 'India'],
    climate: true,
    correlations: ['ZC=F'],
  },
